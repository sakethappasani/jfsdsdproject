    ...
    <form method="post" action="editfaculty">
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="number" id="fid" name="fid" class="form-input" placeholder="Enter Faculty ID" value="${faculty.id}" readonly>
            </div>
            <div class="form-group">
                <label class="form-label" for="fname">Full Name</label>
                <input type="text" id="fname" name="fname" class="form-input" placeholder="Enter Full Name" value="${faculty.name}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="email" id="femail" name="femail" class="form-input" value="${faculty.email}" placeholder="Enter Email" required>
            </div>
            <div class="form-group">
                <label class="form-label" for="fcontact">Contact</label>
                <input type="text" id="fcontact" name="fcontact" class="form-input" value="${faculty.contact}" placeholder="Enter Contact Number" required>
            </div>
        </div>
