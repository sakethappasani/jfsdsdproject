    ...
    <div class="content-container">
        ...
        <table>
            <tr>
                ...
                <th>Gender</th>
                <th>Date of Birth</th>
                <th>Action</th> <!-- Added a column for action (delete and status buttons) -->
            </tr>

            <!-- Loop through the student list and display student data -->
            <c:forEach items="${studentList}" var="std">
                <tr>
                    ...
                    <!-- Action (delete, update, active, block) links -->
                    <td>
                        <a href='<c:url value="adminupdatestudent?sid=${std.id}"></c:url>' class="update-link">Update</a>
                        <c:if test="${std.status=='true'}"><a href='<c:url value="blockstudent/${std.id}"></c:url>' class="block-link">Block</a></c:if>
                        <c:if test="${std.status=='false'}"><a href='<c:url value="unblockstudent/${std.id}"></c:url>' class="active-link">Active</a></c:if>
                    </td>
                </tr>
            </c:forEach>
        </table>
