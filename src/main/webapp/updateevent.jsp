...
<body>
    ...
    <div class="form-container">
        ...
        <form action="saveeditevent" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="form-label" for="ename">Event Name</label>
                <input type="text" class="form-input" id="ename" name="ename" value="${event.name}" required placeholder="Enter event name">
            </div>

            <div class="form-group">
                <label class="form-label" for="edescription">Event Description</label>
                <input type="text" class="form-input" id="edescription" name="edescription" value="${event.description}" required placeholder="Provide a detailed description of the event">
            </div>

            <div class="form-group">
                <label class="form-label" for="ecategory">Event Category</label>
                <input type="text" class="form-input" id="ecategory" name="ecategory" value="${event.category}" required placeholder="Enter event category">
            </div>

            <div class="form-group">
                <label class="form-label" for="evenue">Event Venue</label>
                <input type="text" class="form-input" id="evenue" name="evenue" value="${event.venue}" required placeholder="Enter event location">
            </div>
            
                <div class="form-group">
        <label class="form-label" for="edate">Event Date</label>
        <input type="date" class="form-input" id="edate" value="${event.date}" name="edate" required>
    </div>

    <div class="form-group">
        <label class="form-label" for="etime">Event Time</label>
        <input type="time" class="form-input" id="etime" value="${event.time}" name="etime" required>
    </div>
            
            <div class="form-group">
                <label class="form-label" for="eimage">Event Image</label>
                <div class="file-input-container">
                    <label class="file-input-label">
                        <i class="fas fa-cloud-upload-alt"></i>
                        <span>Choose an image for the event</span>
                        <input type="file" id="eimage" name="eimage" accept="image/*">
                    </label>
                </div>
            </div>

            <input type="hidden" name="eaddedby" value="${admin.username}" />
            <input type="hidden" name="eventId" value="${event.eventid}" />

            <button type="submit" class="submit-btn">
                <i class="fas fa-calendar-plus"></i> Update Event
            </button>
        </form>
    </div>
</body>
