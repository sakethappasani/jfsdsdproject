...
<body>
    ...
    <div class="content">
        <div class="profile-card">
            ...
            <p class="detail">ID:</p>
            <p class="value"><c:out value="${student.id}"></c:out></p>
            
            <p class="detail">Full Name:</p>
            <p class="value"><c:out value="${student.name}"></c:out></p>

            <p class="detail">Gender:</p>
            <p class="value"><c:out value="${student.gender}"></c:out></p>

            <p class="detail">Date of Birth:</p>
            <p class="value"><c:out value="${student.dob}"></c:out></p>

            <p class="detail">Email:</p>
            <p class="value"><c:out value="${student.email}"></c:out></p>

            <p class="detail">Contact:</p>
            <p class="value"><c:out value="${student.contact}"></c:out></p>

            <!-- Updated Edit Button -->
            <a href="stuupdateprofile" class="update-btn">Edit Profile</a>
        </div>
    </div>
