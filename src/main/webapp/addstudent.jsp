		...
		<form method="post" action="insertstudent">
			<div class="form-grid">
				<div class="form-group">
					<label class="form-label" for="sid"> <i
						class="fas fa-id-card"></i> Student ID
					</label> <input type="number" id="sid" name="sid" class="form-input"
						required placeholder="Enter student ID">
				</div>

				<div class="form-group">
					<label class="form-label" for="sgender"> <i
						class="fas fa-venus-mars"></i> Gender
					</label> <select name="sgender" id="sgender" class="form-input" required>
				...
				<div class="form-group">
					<label class="form-label" for="sname"> <i
						class="fas fa-user"></i> Full Name
					</label> <input type="text" id="sname" name="sname" class="form-input"
						required placeholder="Enter Name">
				</div>

				<div class="form-group">
					<label class="form-label" for="semail"> <i
						class="fas fa-envelope"></i> Email Address
					</label> <input type="email" id="semail" name="semail" class="form-input"
						required placeholder="Enter email address">
				</div>

				<div class="form-group">
					<label class="form-label" for="scontact"> <i
						class="fas fa-phone"></i> Contact Number
					</label> <input type="text" id="scontact" name="scontact"
						class="form-input" required placeholder="Enter contact number">
				</div>

				<div class="form-group">
					<label class="form-label" for="sdob"> <i
						class="fas fa-calendar"></i> Date of Birth
					</label> <input type="date" id="sdob" name="sdob" class="form-input"
						required>
				</div>

				<div class="form-group">
					<label class="form-label" for="spwd"> <i
						class="fas fa-lock"></i> Password
					</label> <input type="password" id="spwd" name="spwd" class="form-input"
